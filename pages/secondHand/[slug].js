    ...
    <div>
      ...
      <div className='maylike-products-wrapper'>
        ...
        <div className='marquee'>
          ...
          {products.map((item,i) => (
 <div key={i}>
 <Link href={`/secondHand/${item.slug.current}`}>
...
export const getStaticProps = async ({ params: { slug } }) => {
  const query = `*[_type == "secondhand" && slug.current == '${slug}'][0]`
  const productsQuery = '*[_type == "secondhand"]'
